<template>
    <div class="group relative w-full max-w-[400px]">
        <select class="border-strokeColor bg-sideBarBackgroundColor text-sideBarTextColor focus:border-linkColor w-full cursor-pointer appearance-none rounded-br-[8px] border-2 p-[10px] pr-[40px] pl-[12px] text-[16px] transition-colors duration-300 focus:outline-none" v-model="selectedOption" @change="updateValue($event.target.value)">
