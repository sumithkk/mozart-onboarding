<template>
    <div class="inline-block">
        <!-- Container -->
        <div class="bg-itemColor text-textColor w-64 cursor-pointer overflow-hidden rounded-md shadow-lg">
            <div class="group flex w-full items-center justify-between px-4 py-2">
            ...
            <!-- Divider -->
            <div class="border-primaryColor border-t"></div>

            <!-- Item: Add from Google Drive -->
            <button class="hover:bg-backgroundColor flex w-full cursor-pointer items-center gap-2 px-4 py-2" @click="emits('uploadFromGoogleDrive')">
            ...
            <!-- Item: Upload from computer -->
            <button class="hover:bg-backgroundColor flex w-full cursor-pointer items-center gap-2 px-4 py-2" @click="emits('uploadFromComputer')">
                <div class="materialSymbolsOutlined text-lg">upload</div>
...
<script setup lang="ts">
    const emits = defineEmits(["uploadFromGoogleDrive", "uploadFromComputer", "close"])
</script>
